...
for the case of Israel. The distribution of Israel's bilateral cross border credit is shown in figure \ref{plot_israel_bank_linkages}. Israel's cross border credit is quite concentrated: the United States is the largest counterparty followed by Switzerland and the United Kingdom.

```{r plot_israel_bank_linkages,fig.cap="Israel's cross border credit\\label{plot_israel_bank_linkages}", fig.pos="h", out.extra=""}
...
<!-- The financial cycles of Israel and United States are -->
<!-- plotted in figure \ref{plot_israel_us_cycles}. -->


```{r plot_israel_us_cycles, fig.cap="Israel and US financial cycles\\label{plot_israel_us_cycles}", fig.pos="h", out.extra=""}
...
ggplot(country_df %>% 
  ...
  labs(x = "", y = "Rate of change (YoY)",
       title = "Synchronization of Israel and US financial activity") + 
  theme_bw() + 
...
```{r plot_israel_us,fig.cap=plot_israel_us_cap, fig.pos="H", out.extra=""}

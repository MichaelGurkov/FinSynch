...
files_path_list$oecd_codes = paste0(
  dir_path,"\\Documents\\Data\\ISO\\",
  "iso_3digit_alpha_country","_codes.csv")

raw_data$oecd_codes = read.csv(files_path_list$oecd_codes,
...
eu_df = read.csv(paste0(
  file.path(Sys.getenv("USERPROFILE"),fsep = "\\"),
  "\\Documents\\Data\\Misc\\EU_membership.csv"),
                 stringsAsFactors = FALSE) %>%

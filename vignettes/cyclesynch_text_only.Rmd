...
This work analyzes the relationship between financial integration and financial cycles synchronization. Financial integration refers to the linkage of different financial markets, while financial cycles synchronization refers to the comovement of the main components of the financial cycle (credit, house and share prices). I identify the 
...
The paper is structured as follows. In Section \ref{LitReview} I review the relevant literature and theoretical considerations. Section \ref{Data} provides a description of the data. Empirical specifications are formulated in Section \ref{EmpSpec}. Estimation results are presented in Section \ref{results} and robustness tests are in Section \ref{Robust}. Section \ref{conclusions} concludes the paper.

...
About `r format(mean(fin_reg_df$Crises) * 100,digits = 3)` percent of the observations in the sample refer to crisis periods (where at least one country in the country pair undergoes a financial crisis during this year).

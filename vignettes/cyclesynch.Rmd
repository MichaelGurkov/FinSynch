---
title: "Financial cycles synchronization and financial integration ^[I thank Yossi Saadon, Nimrod Segev, Jonathan Benshimol, Osnat Zohar and the participants of the Bank of Israel Research Department seminar for their helpful comments and suggestions]"
...
This work analyzes the relationship between financial integration and financial cycles synchronization. I identify the 
...
<!-- Why is it important -->
The theory provides ambiguous predictions regarding the effect of financial integration on financial cycles synchronization. On the one hand, financial integration can help diversify risk, redirect capital to more profitable investment opportunities and act as country-specific "shock absorber". In that case, the association between banking integration and financial synchronization should be negative. On the other hand, banking integration can induce contagion effects and act as a global "shock propagator". In that case, a positive association should be observed. This paper examines which affect dominates by studying the connection between banking integration and financial cycles synchronization.
...
predictions with respect to the direction of the association between cycles synchronization and banking linkages in more specific setups such as during financial crises as well as in highly developed market. I analyze those setups in addition to baseline analysis.

<!-- What do you find -->
I find evidence that financial integration is negatively associated with cycles synchronization thus on average act as a shock absorbent. However, the results show that the relationship is state-dependent: I find that during financial crises financial integration is associated with more synchronized financial cycles relative to normal times,indicating that during crises synchronization propagates shocks. In a highly developed financial market, integration is also associated with more synchronized cycles relative to a low level of financial development. 
...
I calculate the percentage difference of each variable and then take a simple average to obtain the growth of the financial cycle. 

...
\begin{equation*}
FinRet_{i,t} = \frac{1}{3} \cdot ln \left(  \frac{TotalCredit_{t}}{TotalCredit_{t-1}} \right) 
+\frac{1}{3} \cdot ln\left( \frac{HousePrice_{t}}{HousePrice_{t-1}} \right) 
+\frac{1}{3} \cdot ln\left( \frac{SharePrice_{t}}{SharePrice_{t-1}} \right)
\end{equation*}    
...
Since the theory is ambiguous on the issue of the effect of banking integration
on financial synchronization, the question becomes an empirical one. Estimation results are shown in table \ref{baseline}. Banking linkages enter the equation with a negative sign, meaning that integration is associated with less synchronized cycles. That means that the "risk absorber" feature dominates the "risk propagator" feature in this case. We can see that this effect is state depended: the interaction terms suggest that during banking crises

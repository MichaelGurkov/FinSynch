...
notes_str = paste0(" Financial cycles synchronization",
                   ...
                   "that equals 1 if both countries are in the eurozone. ")
...
\textcolor{red}{short description of table results}
...
@Fisman2004 analyzes the role of financial development in allocating resources. They argue that global (productivity) shocks will induce comovement of growth rates among countries with a high level of financial development since undeveloped countries will not be able to react to the shocks of other countries. Thus, financial development at a high level can transmit global shocks and induce comovement in economic activity.
...
\textcolor{red}{too short - expand the description and add more results}


Estimation results are shown in table \ref{baseline}. Banking linkages enter the equation with a negative sign, meaning that integration is associated with less synchronized cycles. That means that the "risk absorber" feature dominates the "risk propagator" feature in this case. We can see that this effect is state depended: the interaction terms suggest that during banking crises
periods or in highly developed financial markets integration is associated
with higher synchronization. That finding is in line with the theory that
suggests that the "risk propagator" feature is present in these settings and thus the synchronization should increase relative to base setting. Another finding is that when both countries belong to the eurozone the synchronization also increases perhaps due to absence of currency risk. 

Coefficient analysis shows that banking integration effect is economicaly significant. A change of one standard deviation in banking linkages is
...
\textcolor{red}{too short - add two more paragraphs}

...
The paper is structured as follows. In Section \ref{LitReview}, I review the relevant literature and theoretical considerations. Section \ref{Data} provides a description of the data. Empirical specification are formulated in Section \ref{EmpSpec}.  Estimation results are presented in section \ref{results} and robustness tests in Section \ref{Robust}. Section \ref{conclusions} concludes the paper.

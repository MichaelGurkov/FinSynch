...
notes_str = paste0("Credit cycles synchronization",
                                " is the ",
                                "negative of the absolute difference of ",
                                "credit growth between country",
                                " \\textit{i}",
...
reg_list$no_trend = plm(formula = formula(
  reg_formula %>% sub(pattern = "+CountryPair:Time_Trend",

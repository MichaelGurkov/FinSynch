...
abstract: "This paper studies the relationship between financial cycles synchronization and financial integration.I run panel regression of synchronization vs integration using data on 30 OECD countries. My results suggest that the relationship is state depended: While financial integration acts as \" shock absorber \" during normal times, I find that financial crises increase the \"shock propagation\" feature of banking integration. Overall the results suggest that while banking integration may be desired because it may facilitate risk diversification, additional macro prudential measures may be warranted to account for the risk exposure during crisis times."
...
countries_list = list(
  oecd_countries = c("Australia","Austria","Belgium","Canada","Chile",
                     ...
                     ,"United_States"),
  kpp_countries = c("Australia","Austria","Belgium","Canada",
...
where:
$i,j$ - country index
$Assets_{i,j}$ - total assets of banks in country $i$ in country $j$
$Liabilities_{i,j}$ - total liabilities of banks in country $j$ in country $i$
...
One implication for the Euro block (that is charactarized by one currency and very developed financial markets) is that the sum of the coefficients suggest that during a financial crises European Union's banking ystem may have a cumulative effect of shock propagation and not
risk absorbency.
